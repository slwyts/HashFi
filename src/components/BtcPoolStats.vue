...
const totalMined = computed(() => {
  if (!btcData.value || btcData.value.totalMined <= 0) return '0.00000000';
...
const difficulty = computed(() => {
  if (!btcData.value || btcData.value.difficulty <= 0) return '0';
