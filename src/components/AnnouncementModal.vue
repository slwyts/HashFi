        ...
        <div class="bg-white rounded-lg max-w-lg w-full max-h-[80vh] overflow-hidden border border-gray-200">
          ...
          <div class="border-b border-gray-200 p-5 relative">
            <div class="flex items-start gap-3">
              <!-- 重要公告图标 -->
              <div v-if="announcement.isImportant" class="flex-shrink-0 w-6 h-6 rounded bg-blue-50 flex items-center justify-center">
              ...
              <div class="flex-1">
                ...
                <p class="text-xs text-gray-500">{{ formatDate(announcement.timestamp) }}</p>
              </div>
              <!-- 关闭按钮 -->
              <button
                @click="handleClose"
